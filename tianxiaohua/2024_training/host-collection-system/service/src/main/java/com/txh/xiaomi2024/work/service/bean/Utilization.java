...
public class Utilization {
    ...
    public Utilization(String metric, String endpoint, long collect_time, int step, double value_metric) {
        this.metric = metric;
    ...
    public Utilization(String metric, long collect_time, double value_metric) {
        this.metric = metric;
        this.collect_time = collect_time;
        this.value_metric = value_metric;
    }
