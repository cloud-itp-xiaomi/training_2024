...
public class ESSearchBase {
     ...
     */
    public SearchSourceBuilder sourceBuilderInit(SourceBuildContent... contents) {
        ...
        for (SourceBuildContent content : contents) {
     ...
     * @return SearchResponse
     */
    public SearchResponse basicSearch(String index, SourceBuildContent... contents) {
